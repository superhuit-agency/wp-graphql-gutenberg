		...
		add_action('admin_menu', function () {
			add_menu_page(
				...
				function () {
					...
					echo '<div class="wrap"><div id="wp-graphql-gutenberg-admin"></div>';
					echo '<h2>' . esc_html__( 'blocksJSON Filter', 'wp-graphql-gutenberg' ) . '</h2>';
					echo '<form method="post" action="options.php">';
					settings_fields( 'wp_graphql_gutenberg' );
					echo '<table class="form-table" role="presentation"><tbody><tr><th scope="row"><label for="wp-graphql-gutenberg-blocks-json-filtered-properties">' . esc_html__( 'Filtered property names', 'wp-graphql-gutenberg' ) . '</label></th><td>';
